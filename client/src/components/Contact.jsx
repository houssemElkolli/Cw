...
const Contact = () => {
  ...
  const handleFormSubmit = (data, onSubmitProps) => {
    console.log(data);
    axios.post("http://localhost:3001/contacts/addContactForm", data)
      .then((res) => {
          ...
          {change ? 
            ...
            >
              ...
              <Box
                ...
                >
                 before we reply to your message we need you to
                  verify that you are
                ...
                <a className='button-00' type='button' href='https://mail.google.com/mail' target="blank" >Please Go to Email</a>
                ...
                <form onSubmit={handleSubmit}>
                  <Box sx={{
                    ...
                    <Box className='form-box'>
                      ...
                      <Typography className="typo" variant="h3" component="h3"
                        sx={{
                          gridColumn: "span 4",
                          justifySelf: 'center',
                          letterSpacing: '2px',
                      ...
                      <TextField
                        ...
                        maxRows={3}
                        minRows={3}
                        sx={{ gridColumn: "span 4", resize: "none" }}
                        onBlur={handleBlur}
                        onChange={handleChange}
