...
export default function PartnersTable({ rld }) {
  ...
  useEffect(() => {
    axios.get("http://localhost:3001/contacts/getContacts").then((res) => {
  ...
  const deleteSlectedItems = () => {
    ...
    axios.post("http://localhost:3001/contacts/deleteContact", selected).then((res) => {
      console.log(res);
