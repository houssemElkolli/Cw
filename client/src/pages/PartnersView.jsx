...
const PartnersView = () => {
    ...
    return (
        <Container className="PartnersView">
            {lod &&
                <>
                    <Typography variant="h3"  sx={{fontFamily : 'poppins, cursive' , marginTop : '20px', color : '#494949' }}>Our Partners </Typography>
                    <ImageList gap={10} cols={6} sx={{ padding: '5px' }}   >
                        {partners.map((item) => (
                            <ImageListItem key={item._id} sx={{ height: '180px', width: '180px', boxShadow: '1px 2px 5px rgb(131, 131, 131)' }}>
                                <img
